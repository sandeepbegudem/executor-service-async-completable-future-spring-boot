...
public class Employees {
    ...
    public Employees(String employeeId, String firstName, String lastName, String email, String gender, String newJoiner, String learningPending, int salary, int rating) {
    ...
    public String isLearningPending() {
